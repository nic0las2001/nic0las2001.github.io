/*!
 * undefined vundefined | © undefined undefined | undefined Licensed | undefined
 */
(function (collapse_js, Tooltip) {
  ...
  function categoryCollapse() {
    _toConsumableArray(children).forEach(function (elem) {
      var id = parentPrefix + elem.id.substring(childPrefix.length);
